...
exports.getDriverOfOrderInformation = async (req, res, next) => {
    ...
    return (async () => {
        ...
        if (ord_code == undefined || off_code == undefined || filter == undefined || lic_code == undefined || action == undefined) {
            ...
            and tbl_order.dver_code = tbl_driver.dver_code) as job_currently,
            ...
            if (!tbl_temporary.code) {
                ...
                if (tbl_temporary.data.length > 0) {
                    ...
                    for (var xdver = 0; xdver <= tbl_temporary.data.length - 1; xdver++) {
                        ...
                        } else if (tbl_temporary.data[xdver].job_currently > 0) {
                            tbl_temporary.data[xdver].checked = '0'
                            tbl_temporary.data[xdver].dver_resson = 'พนักงานมีงานในวันจัดส่งแล้ว'
                        }
