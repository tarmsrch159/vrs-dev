...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_vehicle_compartment (
	veh_compartment_code character varying(50) NOT NULL,
	veh_code character varying(50) NOT NULL,
	veh_compartment_number character varying(20) NOT NULL,
	veh_compartment_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(veh_compartment_code)
);`;
