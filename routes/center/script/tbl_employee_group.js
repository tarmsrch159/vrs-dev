...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_employee_group (
	emp_group_code character varying(50) NOT NULL,
	emp_group_desc character varying(200) NOT NULL,
	emp_group_flag character varying(2) NOT NULL,
