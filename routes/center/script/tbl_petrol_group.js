...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_petrol_group (
	ptrl_group_code character varying(50) NOT NULL,
	ptrl_group_desc character varying(200) NOT NULL,
	ptrl_group_short_desc character varying(100),
	ptrl_group_flag character varying(2) NOT NULL,
