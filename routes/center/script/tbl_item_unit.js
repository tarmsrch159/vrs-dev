...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_item_unit (
	itm_unit_code character varying(50) NOT NULL,
	itm_unit_desc character varying(200) NOT NULL,
	itm_unit_short_desc character varying(100) NOT NULL,
	itm_unit_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(itm_unit_code)
);`;
