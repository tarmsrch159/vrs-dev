...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_driver_group (
	dver_group_code character varying(50) NOT NULL,
	dver_group_desc character varying(50) NOT NULL,
	dver_group_flag character varying(2) NOT NULL,
