...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_petrol_vehicle_type (
	ptrl_vehicle_type_code character varying(50) NOT NULL,
	ptrl_code character varying(50) NOT NULL,
	veh_type_code character varying(50) NOT NULL,
	ptrl_vehicle_type_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(ptrl_vehicle_type_code)
	);`;
