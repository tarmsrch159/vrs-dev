...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_driver_leave_type (
	dver_leave_type_code character varying(50) NOT NULL,
	dver_leave_type_desc character varying(200) NOT NULL,
	dver_leave_type_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(dver_leave_type_code)
);`;
