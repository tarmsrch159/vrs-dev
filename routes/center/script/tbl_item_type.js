...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_item_type (
	itm_type_code character varying(50) NOT NULL,
	itm_type_desc character varying(200) NOT NULL,
	itm_type_short_desc character varying(100) NOT NULL,
	itm_type_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(itm_type_code)
);`;
