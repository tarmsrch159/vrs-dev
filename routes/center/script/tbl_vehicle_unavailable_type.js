...
exports.execute = async (databse) => {
    ...
    let script = `CREATE TABLE IF NOT EXISTS public.tbl_vehicle_unavailable_type (
	veh_unavailable_type_code character varying(50) NOT NULL,
	veh_unavailable_type_desc character varying(200) NOT NULL,
	veh_unavailable_type_flag character varying(2) NOT NULL,
	ist_dt timestamp without time zone NOT NULL,
	mdf_dt timestamp without time zone,
	rm_dt timestamp without time zone,
	PRIMARY KEY(veh_unavailable_type_code)
);`;
